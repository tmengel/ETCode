...
// main function:
int fitlam2v4(){
	std::ofstream datFile ("compfitLAMResults.dat", std::ofstream::app);
	datFile << "FIT"<< "\t" << "CollEn"<< "\t"
			<< "particle" << "\t"
			<< "centrality" << "\t"
			<< "mass" << "\t"
	...
	while((mikey=(TKey*)next())){
	  breakOutForTesting++;
		if (breakOutForTesting<49) continue;// 140 histograms already analyzed
		...
		*/
		...
		else if(collEn == 7.7||collEn == 11.5||collEn == 19.6 || collEn == 27 || collEn  ==39){
		...
		if(collEn == 200||collEn == 130){
		  if(centrality == "4"){
		    	NpartAndArrPtr2 = getNpartAndErr(collEn,centrality); // 40-50%
			Npart2 = *(NpartAndArrPtr2+0);
			NpartAndArrPtr2 = getNpartAndErr(collEn,"5");
			Npart2+=*(NpartAndArrPtr2+0);
			NpartAndArrPtr2 = getNpartAndErr(collEn,"6");
			Npart2+=*(NpartAndArrPtr2+0);
		        NpartAndArrPtr2 = getNpartAndErr(collEn,"7"); // 60-70%
			Npart2+= *(NpartAndArrPtr2+0);
			NpartAndArrPtr2 = getNpartAndErr(collEn,"8"); // 70-80%
		  }
		         Npart2 += *(NpartAndArrPtr2+0); // added the two, next average:
			 Double_t tempAvg = Npart2/5.;
			 Npart2 = ceil(tempAvg); // FIXME rounded down
			 // for a conservative estimate, take the bigger error between the two (50-60%):
			 NpartErr2 = *(NpartAndArrPtr2+0);
		}
		else if(collEn == 7.7||collEn == 11.5||collEn == 19.6 || collEn == 27 || collEn  ==39){
		...
		if ((particleID=="la_" || particleID=="ala") &&	(centrality == "5" || centrality == "6")){
			 if(centrality == "5") // which should be 40-60% for lambdas
			 {
			 	NpartAndArrPtr2 = getNpartAndErr(collEn,centrality); // 40-50%
			 	Npart2 = *(NpartAndArrPtr2+0);
			 	NpartAndArrPtr2 = getNpartAndErr(collEn,"6"); // 50-60%
		...
		if(collEn == 200||collEn == 130){
		  if(centrality == "4"){
		    	NpartAndArrPtrH = getNpartAndErr(collEn,centrality); // 40-50%
			NpartH = *(NpartAndArrPtrH+0);
			NpartAndArrPtrH = getNpartAndErr(collEn,"5");
			NpartH+=*(NpartAndArrPtrH+0);
			NpartAndArrPtrH = getNpartAndErr(collEn,"6");
			NpartH+=*(NpartAndArrPtrH+0);
		        NpartAndArrPtrH = getNpartAndErr(collEn,"7"); // 60-70%
			NpartH+= *(NpartAndArrPtrH+0);
			NpartAndArrPtrH = getNpartAndErr(collEn,"8"); // 70-80%
		  }
		         NpartH += *(NpartAndArrPtrH+0); // added the two, next average:
			 Double_t tempAvg = NpartH/5.;
			 NpartH = ceil(tempAvg); // FIXME rounded down
			 // for a conservative estimate, take the bigger error between the two (50-60%):
			 NpartErrH = *(NpartAndArrPtrH+0);
		}
		else if(collEn == 7.7||collEn == 11.5||collEn == 19.6 || collEn == 27 || collEn  ==39){
		...
		if ((particleID=="la_" || particleID=="ala") &&	(centrality == "5" || centrality == "6")){
			 if(centrality == "5") // which should be 40-60% for lambdas
			 {
			 	NpartAndArrPtrH = getNpartAndErr(collEn,centrality); // 40-50%
			 	NpartH = *(NpartAndArrPtrH+0);
			 	NpartAndArrPtrH = getNpartAndErr(collEn,"6"); // 50-60%
		...
		if(collEn == 200||collEn == 130){
		  if(centrality == "4"){
		    	NpartAndArrPtrE = getNpartAndErr(collEn,centrality); // 40-50%
			NpartE = *(NpartAndArrPtrE+0);
			NpartAndArrPtrE = getNpartAndErr(collEn,"5");
			NpartE+=*(NpartAndArrPtrE+0);
			NpartAndArrPtrE = getNpartAndErr(collEn,"6");
			NpartE+=*(NpartAndArrPtrE+0);
		        NpartAndArrPtrE = getNpartAndErr(collEn,"7"); // 60-70%
			NpartE+= *(NpartAndArrPtrE+0);
			NpartAndArrPtrE = getNpartAndErr(collEn,"8"); // 70-80%
		  }
		         NpartE += *(NpartAndArrPtrE+0); // added the two, next average:
			 Double_t tempAvg = NpartE/5.;
			 NpartE = ceil(tempAvg); // FIXME rounded down
			 // for a conservative estimate, take the bigger error between the two (50-60%):
			 NpartErrE = *(NpartAndArrPtrE+0);
		}
		else if(collEn == 7.7||collEn == 11.5||collEn == 19.6 || collEn == 27 || collEn  ==39){
		...
		if ((particleID=="la_" || particleID=="ala") &&	(centrality == "5" || centrality == "6")){
			 if(centrality == "5") // which should be 40-60% for lambdas
			 {
			 	NpartAndArrPtrE = getNpartAndErr(collEn,centrality); // 40-50%
			 	NpartE = *(NpartAndArrPtrE+0);
			 	NpartAndArrPtrE = getNpartAndErr(collEn,"6"); // 50-60%
		...
		if(collEn == 200||collEn == 130){
		  if(centrality == "4"){
		    	NpartAndArrPtrE2 = getNpartAndErr(collEn,centrality); // 40-50%
			NpartE2 = *(NpartAndArrPtrE2+0);
			NpartAndArrPtrE2 = getNpartAndErr(collEn,"5");
			NpartE2+=*(NpartAndArrPtrE2+0);
			NpartAndArrPtrE2 = getNpartAndErr(collEn,"6");
			NpartE2+=*(NpartAndArrPtrE2+0);
		        NpartAndArrPtrE2 = getNpartAndErr(collEn,"7"); // 60-70%
			NpartE2+= *(NpartAndArrPtrE2+0);
			NpartAndArrPtrE2 = getNpartAndErr(collEn,"8"); // 70-80%
		  }
		         NpartE2 += *(NpartAndArrPtrE2+0); // added the two, next average:
			 Double_t tempAvg = NpartE2/5.;
			 NpartE2 = ceil(tempAvg); // FIXME rounded down
			 // for a conservative estimate, take the bigger error between the two (50-60%):
			 NpartErrE2 = *(NpartAndArrPtrE2+0);
		}
		else if(collEn == 7.7||collEn == 11.5||collEn == 19.6 || collEn == 27 || collEn  ==39){
		...
		if ((particleID=="la_" || particleID=="ala") &&	(centrality == "5" || centrality == "6")){
			 if(centrality == "5") // which should be 40-60% for lambdas
			 {
			 	NpartAndArrPtrE2 = getNpartAndErr(collEn,centrality); // 40-50%
			 	NpartE2 = *(NpartAndArrPtrE2+0);
			 	NpartAndArrPtrE2 = getNpartAndErr(collEn,"6"); // 50-60%
