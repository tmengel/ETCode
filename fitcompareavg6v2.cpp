...
int fitcompareavg6v2(){
	...
	int stop =300; // breakOut after this many iterations (if achieved); default: 140
	cout << "Flag" << endl;
	while((mikey=(TKey*)next())){
	  breakOutForTesting++;
		if (breakOutForTesting<250) continue;// 140 histograms already analyzed
