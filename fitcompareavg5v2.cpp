...
int fitcompareavg5v2(){
	...
	int stop =250; // breakOut after this many iterations (if achieved); default: 140
	cout << "Flag" << endl;
	while((mikey=(TKey*)next())){
	  breakOutForTesting++;
		if (breakOutForTesting<200) continue;// 140 histograms already analyzed
