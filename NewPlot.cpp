   ...
   part9->SetBorderSize(0);
	...
	while((mikey=(TKey*)next())){
	  breakOutForTesting++;
		...
		if(histoName.substr( histoName.length() - 4 ) == "62.4") collEn = 62.4;
		...
		HAGE->SetLineWidth(2);
		funcBGBW2->SetLineWidth(2);
		funcBGBW->SetLineWidth(2);
		
		ROOT::Math::MinimizerOptions::SetDefaultMaxFunctionCalls(20000);
		TString xlabel = "p_{T}";
		TString ylabel = "#frac{d^{2}N}{dydp_{T}}";
		TString b1 = "#pi^{+} 62.4 GeV";
		TString b2= "#pi^{+} 130 GeV";
		TString b3= "#pi^{+} 200 GeV";
		TString b4= "k^{+}  62.4 GeV";
		TString b5= "k^{+}  130 GeV";
		TString b6= "k^{+}  200 GeV";
	        TString b7= "p 62.4 GeV";
		TString b8= "p 130 GeV";
